        ...
        {!isReview && !isFreePractice ? (
          ...
          <div className="grid grid-cols-3 gap-3 animate-in fade-in slide-in-from-bottom-2">
            <button
              ...
              className="py-4 bg-red-100 hover:bg-red-200 text-red-700 dark:bg-red-900/30 dark:text-red-400 rounded-2xl font-bold transition-colors active:scale-95"
            >
              Schwer
            </button>
            <button
              onClick={() => handleReviewAnswer(1)}
              className="py-4 bg-blue-100 hover:bg-blue-200 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 rounded-2xl font-bold transition-colors active:scale-95"
            >
              Gut
            </button>
            <button
              onClick={() => handleReviewAnswer(2)}
              className="py-4 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 rounded-2xl font-bold transition-colors active:scale-95"
            >
              Leicht
            </button>
          </div>
